...
CREATE SEQUENCE  "ARGUS_TASK"."GEN_NODE_TYPE"  MINVALUE 10 MAXVALUE 9999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE;
/
...
CREATE SEQUENCE  "ARGUS_TASK"."GEN_NODE"  MINVALUE 100 MAXVALUE 9999999 INCREMENT BY 1 START WITH 121 CACHE 20 NOORDER  NOCYCLE;
/
...
CREATE SEQUENCE  "ARGUS_TASK"."GEN_CU"  MINVALUE 100 MAXVALUE 999999999 INCREMENT BY 1 START WITH 61 CACHE 20 NOORDER  NOCYCLE;
/
...
CREATE SEQUENCE  "ARGUS_TASK"."GEN_CP"  MINVALUE 10000 MAXVALUE 999999999 INCREMENT BY 1 START WITH 1881 CACHE 20 NOORDER  NOCYCLE;
/
...
CREATE SEQUENCE  "ARGUS_TASK"."GEN_STUB_LINK"  MINVALUE 1000 MAXVALUE 99999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE;
/
...
CREATE SEQUENCE  "ARGUS_TASK"."GEN_CABLE_LINKS"  MINVALUE 100 MAXVALUE 999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE ;
/
...
INSERT INTO INV_OPERATION_TEXT (TABLE_NAME, ACTION, SCRIPT)
    VALUES ('NODE_TYPE', 'Создать тип узла','DECLARE 
    -- Заполнить
...
INSERT INTO INV_OPERATION_TEXT (TABLE_NAME, ACTION, SCRIPT)
    VALUES ('NODE', 'Создать узел','DECLARE 
...
INSERT INTO INV_OPERATION_TEXT (TABLE_NAME, ACTION, SCRIPT)
    VALUES ('CONNECTION_UNIT', 'Создать ОКУ, при создании ОКУ автоматически создаются точки','DECLARE
...
INSERT INTO INV_OPERATION_TEXT (TABLE_NAME, ACTION, SCRIPT)
    VALUES ('CONNECTION_UNIT', 'Выборка ОКУ, по конкретному узлу','SELECT 
...
INSERT INTO INV_OPERATION_TEXT (TABLE_NAME, ACTION, SCRIPT)
    VALUES ('CABLE_LINK', 'Создать подключение','DECLARE
...
BEGIN
    -- Проверяем есть ли STUB_LINK для точки L_CP_ID
    BEGIN
...
INSERT INTO INV_OPERATION_TEXT (TABLE_NAME, ACTION, SCRIPT)
    VALUES ('CABLE_LINK', 'Выбрать все подключения для узла','SELECT 
...
INSERT INTO INV_OPERATION_TEXT (TABLE_NAME, ACTION, SCRIPT)
    VALUES ('CABLE_LINK', 'Выбрать все подключения для ОКУ','SELECT 
  nt.node_type_short_name||n.node_name||''-''||cu.cu_number as "cuName",
  cp.cp_name as "firstCpName",
  cp.cp_name as "endCpName",
  lnt.node_type_short_name||ln.node_name||''-''||lcu.cu_number as "linkedCuName",
